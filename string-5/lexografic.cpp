...
// his birthday. The strings consist of uppercase and lowercase Latin 
...
// It is guaranteed that the strings are of the same length and also consist 
...
// , print "1". If the strings are equal, print "0". Note that the letters' case is not taken into consideration when the strings are compared.kjd
#include<bits/stdc++.h>
using namespace std;
int main(){
    string first_string;
